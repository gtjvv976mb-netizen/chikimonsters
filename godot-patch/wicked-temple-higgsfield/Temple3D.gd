...
func _build() -> void:
	...
	e.ambient_light_color = Color(0.65, 0.63, 0.73) if not _low \
		else Color(0.68, 0.66, 0.76)
	...
	e.ambient_light_energy = 1.12 if not _low else 1.17
	e.fog_enabled = not _low
	e.fog_light_color = Color(0.20, 0.10, 0.28)
	# Keep the far sanctums atmospheric without laying a violet veil over nearby mortar.
	e.fog_density = 0.006
