...
func _build_hud() -> void:
	...
	_wave_label = _hud_label("", int(PHONE_FONTS["wave"]) if _low else 21, Color("f6f1e7"))
	...
	_run_status_label = _hud_label("PURGE RUN  /  LIVE", 10 if _low else 11, Color("55e3df"))
	...
	_score_label = _hud_label("", int(PHONE_FONTS["score"]) if _low else 17, Color("f6f1e7"))
	...
	_exit_button.add_theme_stylebox_override("normal", _hud_style(
		Color(0.08, 0.025, 0.035, 0.90), Color("c94d61"), 1, 0))
	_exit_button.add_theme_stylebox_override("hover", _hud_style(
		Color(0.20, 0.035, 0.055, 0.96), Color("ff6478"), 2, 0))
	_exit_button.add_theme_stylebox_override("pressed", _hud_style(
		Color(0.30, 0.04, 0.06, 1.0), Color("fff0eb"), 2, 0))
...
func _build_touch_hud() -> void:
	...
	_page_button.add_theme_color_override("font_color", Color("d9fffb"))
	_page_button.add_theme_stylebox_override("normal", _hud_style(
		Color(0.012, 0.055, 0.075, 0.90), Color(0.33, 0.89, 0.87, 0.64), 1, 0))
	_page_button.add_theme_stylebox_override("hover", _hud_style(
		Color(0.025, 0.13, 0.15, 0.96), Color("55e3df"), 2, 0))
	_page_button.add_theme_stylebox_override("pressed", _hud_style(
		Color(0.06, 0.22, 0.23, 0.98), Color("f6f1e7"), 2, 0))
	...
	_settings_button.add_theme_color_override("font_color", Color("cde5e9"))
	_settings_button.add_theme_stylebox_override("normal", _hud_style(
		Color(0.012, 0.04, 0.06, 0.88), Color(0.30, 0.51, 0.56, 0.72), 1, 0))
	_settings_button.add_theme_stylebox_override("hover", _hud_style(
		Color(0.025, 0.10, 0.13, 0.96), Color("55e3df"), 2, 0))
	_settings_button.add_theme_stylebox_override("pressed", _hud_style(
		Color(0.05, 0.17, 0.19, 0.98), Color("f6f1e7"), 2, 0))
	...
	_camera_button.add_theme_stylebox_override("normal", _hud_style(
		Color(0.012, 0.055, 0.075, 0.92), Color("55e3df"), 1, 0))
	_camera_button.add_theme_stylebox_override("hover", _hud_style(
		Color(0.025, 0.14, 0.16, 0.98), Color("a8fffa"), 2, 0))
	_camera_button.add_theme_stylebox_override("pressed", _hud_style(
		Color(0.06, 0.23, 0.24, 1.0), Color("f6f1e7"), 2, 0))
		...
		if b != null and is_instance_valid(b):
			...
			for style_name in ["normal", "hover", "pressed"]:
				...
				if button_style != null:
					...
					button_style.set_corner_radius_all(48 if b == _dodge_button else 7)
